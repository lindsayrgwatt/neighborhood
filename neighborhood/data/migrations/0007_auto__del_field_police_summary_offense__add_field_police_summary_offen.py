...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Police.summary_offense'
        db.delete_column('data_police', 'summary_offense')
    ...
    def backwards(self, orm):
        # Adding field 'Police.summary_offense'
        db.add_column('data_police', 'summary_offense',
                      self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True),
                      keep_default=False)
