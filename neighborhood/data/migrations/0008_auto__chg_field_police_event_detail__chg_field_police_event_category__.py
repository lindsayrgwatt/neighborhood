...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Police.event_category'
        db.alter_column('data_police', 'event_category', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Police.effective_date'
        db.alter_column('data_police', 'effective_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Police.event_aggregate_category'
        db.alter_column('data_police', 'event_aggregate_category', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Police.event_detail'
        raise RuntimeError("Cannot reverse this migration. 'Police.event_detail' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Police.event_category'
        raise RuntimeError("Cannot reverse this migration. 'Police.event_category' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Police.effective_date'
        raise RuntimeError("Cannot reverse this migration. 'Police.effective_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Police.event_aggregate_category'
        raise RuntimeError("Cannot reverse this migration. 'Police.event_aggregate_category' and its values cannot be restored.")
    ...
    models = {
        ...
        'data.police': {
            ...
            'event_detail': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
