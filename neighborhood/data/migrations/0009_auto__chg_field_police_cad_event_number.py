...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Police.cad_event_number'
        db.alter_column('data_police', 'cad_event_number', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Police.cad_event_number'
        db.alter_column('data_police', 'cad_event_number', self.gf('django.db.models.fields.IntegerField')(null=True))
