...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LandPermit.permit_type'
        db.alter_column('data_landpermit', 'permit_type', self.gf('django.db.models.fields.CharField')(max_length=40))

    def backwards(self, orm):

        # Changing field 'LandPermit.permit_type'
        db.alter_column('data_landpermit', 'permit_type', self.gf('django.db.models.fields.CharField')(max_length=30))
