...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Police.hundred_block_location'
        db.alter_column('data_police', 'hundred_block_location', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'Police.offense_code'
        db.alter_column('data_police', 'offense_code', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'Police.event_clearance_group'
        db.alter_column('data_police', 'event_clearance_group', self.gf('django.db.models.fields.CharField')(max_length=34, null=True))

        # Changing field 'Police.event_clearance_description'
        db.alter_column('data_police', 'event_clearance_description', self.gf('django.db.models.fields.CharField')(max_length=75, null=True))

        # Changing field 'Police.zone_beat'
        db.alter_column('data_police', 'zone_beat', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Police.district_sector'
        db.alter_column('data_police', 'district_sector', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'Police.offense_type'
        db.alter_column('data_police', 'offense_type', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

    def backwards(self, orm):

        # Changing field 'Police.hundred_block_location'
        db.alter_column('data_police', 'hundred_block_location', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Police.offense_code'
        db.alter_column('data_police', 'offense_code', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))

        # Changing field 'Police.event_clearance_group'
        db.alter_column('data_police', 'event_clearance_group', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
