...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Police.general_offense_number'
        db.alter_column('data_police', 'general_offense_number', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'Police.general_offense_number'
        db.alter_column('data_police', 'general_offense_number', self.gf('django.db.models.fields.IntegerField')())
