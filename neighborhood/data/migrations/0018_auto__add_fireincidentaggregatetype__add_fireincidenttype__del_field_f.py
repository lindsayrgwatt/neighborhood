...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('data_fireincidentaggregatetype', (
            ...
            ('description', self.gf('django.db.models.fields.CharField')(max_length=30, db_index=True)),
        ))
        ...
        # Deleting field 'Fire.incident_type'
        db.delete_column('data_fire', 'incident_type')

        # Deleting field 'Fire.aggregate_incident_type'
        db.delete_column('data_fire', 'aggregate_incident_type')

        # Adding field 'Fire.incident_category'
        db.add_column('data_fire', 'incident_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.FireIncidentType'], null=True),
                      keep_default=False)

        # Adding field 'Fire.incident_aggregate_category'
        db.add_column('data_fire', 'incident_aggregate_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.FireIncidentAggregateType'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Fire.incident_type'
        raise RuntimeError("Cannot reverse this migration. 'Fire.incident_type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Fire.aggregate_incident_type'
        raise RuntimeError("Cannot reverse this migration. 'Fire.aggregate_incident_type' and its values cannot be restored.")
        # Deleting field 'Fire.incident_category'
        db.delete_column('data_fire', 'incident_category_id')

        # Deleting field 'Fire.incident_aggregate_category'
        db.delete_column('data_fire', 'incident_aggregate_category_id')
    ...
    models = {
        ...
        'data.fireincidentaggregatetype': {
            ...
            'description': ('django.db.models.fields.CharField', [], {'max_length': '30', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
