...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing index on 'FireIncidentAggregateType', fields ['description']
        db.delete_index('data_fireincidentaggregatetype', ['description'])

        # Adding unique constraint on 'FireIncidentAggregateType', fields ['description']
        db.create_unique('data_fireincidentaggregatetype', ['description'])

        # Removing index on 'FireIncidentType', fields ['description']
        db.delete_index('data_fireincidenttype', ['description'])

        # Adding unique constraint on 'FireIncidentType', fields ['description']
        db.create_unique('data_fireincidenttype', ['description'])


    def backwards(self, orm):
        # Removing unique constraint on 'FireIncidentType', fields ['description']
        db.delete_unique('data_fireincidenttype', ['description'])

        # Adding index on 'FireIncidentType', fields ['description']
        db.create_index('data_fireincidenttype', ['description'])

        # Removing unique constraint on 'FireIncidentAggregateType', fields ['description']
        db.delete_unique('data_fireincidentaggregatetype', ['description'])

        # Adding index on 'FireIncidentAggregateType', fields ['description']
        db.create_index('data_fireincidentaggregatetype', ['description'])
