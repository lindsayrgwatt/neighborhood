...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BuildingPermit.value_range'
        db.add_column('data_buildingpermit', 'value_range',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.PermitValue'], null=True),
                      keep_default=False)

        # Adding field 'LandPermit.value_range'
        db.add_column('data_landpermit', 'value_range',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.PermitValue'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BuildingPermit.value_range'
        db.delete_column('data_buildingpermit', 'value_range_id')

        # Deleting field 'LandPermit.value_range'
        db.delete_column('data_landpermit', 'value_range_id')
