...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Violation.group'
        db.add_column('data_violation', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.ViolationCategory'], null=True),
                      keep_default=False)

        # Adding field 'Violation.aggregate'
        db.add_column('data_violation', 'aggregate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.ViolationAggregateCategory'], null=True),
                      keep_default=False)

        # Adding field 'FoodViolation.group'
        db.add_column('data_foodviolation', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.ViolationCategory'], null=True),
                      keep_default=False)

        # Adding field 'FoodViolation.aggregate'
        db.add_column('data_foodviolation', 'aggregate',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.ViolationAggregateCategory'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Violation.group'
        db.delete_column('data_violation', 'group_id')

        # Deleting field 'Violation.aggregate'
        db.delete_column('data_violation', 'aggregate_id')

        # Deleting field 'FoodViolation.group'
        db.delete_column('data_foodviolation', 'group_id')

        # Deleting field 'FoodViolation.aggregate'
        db.delete_column('data_foodviolation', 'aggregate_id')
