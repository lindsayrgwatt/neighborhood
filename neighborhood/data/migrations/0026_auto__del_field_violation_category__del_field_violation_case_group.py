...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Violation.category'
        db.delete_column('data_violation', 'category')

        # Deleting field 'Violation.case_group'
        db.delete_column('data_violation', 'case_group')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Violation.category'
        raise RuntimeError("Cannot reverse this migration. 'Violation.category' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Violation.case_group'
        raise RuntimeError("Cannot reverse this migration. 'Violation.case_group' and its values cannot be restored.")
